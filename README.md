...
- 🏆 **Competitive programmer** — participated in multiple competitions, consistently tackling algorithmic challenges
- 📱 **Flutter developer** — built cross-platform apps with clean architecture and smooth UX
- 🌐 **Web developer** — 3 years of crafting responsive, accessible web interfaces
- 🐧 **Linux power user** — comfortable in the terminal; scripting, file management, and workflow automation
- 🎨 **Design-aware** — using Figma to bridge the gap between design and development
...
I'm always open to interesting projects, collaboration, and opportunities. Feel free to reach out!
